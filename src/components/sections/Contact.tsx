...
export function Contact({ properties }: { properties: Property[] }) {
  return (
    <section className="bg-background">
      <div className="bg-primary pb-20 pt-20 sm:pb-24">
        <motion.div
          initial="hidden"
          animate="show"
          variants={fadeUp}
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-accent">Request a Viewing</p>
          <h2 className="font-display mt-3 text-3xl font-normal tracking-tight text-white sm:text-4xl">
            Let&apos;s Find Your Next Property
          </h2>
          <p className="mt-4 text-base leading-relaxed text-[#d5ded9]">
          ...
          <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
            <a
              ...
              className="flex items-center gap-2 rounded-lg border border-white/20 px-4 py-2 text-sm font-medium text-white transition-colors hover:border-accent hover:text-accent"
            >
      ...
      <div className="relative mx-auto -mt-12 max-w-4xl px-4 pb-20 sm:-mt-14 sm:px-6 sm:pb-24 lg:px-8">
        <Reveal variants={fadeUp} className="rounded-xl border border-border bg-surface p-6 sm:p-10">
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
          <Reveal variants={slideFromLeft} className="rounded-xl border border-border bg-surface p-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              {SOCIAL_LINKS.map((s) => (
                <a
                  ...
                  className="flex items-center gap-2 rounded-lg border border-border px-3 py-2.5 text-sm font-medium text-foreground/70 transition-colors hover:border-primary hover:text-primary"
                >
          ...
          <Reveal variants={slideFromRight} className="rounded-xl border border-border bg-background-secondary p-5">
